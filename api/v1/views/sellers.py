...
@app_views.route("/sellers", method=['GET'])
def get_sellers():
    """Get all sellers"""
...
@app_views.route("sellers/<seller_id>", method=['GET'])
...
@app_views.route("sellers/<seller_id>", method=['POST'])
...
@app_views.route("sellers/<seller_id>", method=['DELETE'])
