...
const TABLE_HEAD = [
  ...
  { id: "transaction", label: "Completed transactions", alignRight: false },
  { id: "amount", label: "Total Spent", alignRight: false },
  { id: "" },
];
      ...
      <Container>
		...
		<div className="d-lg-flex d-md-grid ms-3">
            ...
            <span className="select-text">
              Select a buyer to chat and start transactions with{" "}
            </span>
          </div>
          <Scrollbar>
